    ...
    <div class="card pt-2 mb-6 mb-xl-9" style="margin: 10px; padding: 10px">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">Loan</span>
        ...
        <div class="card-body pt-0">
            <table id="kt_customer_details_invoices_table_1"
                ...
                @foreach($pays as $pay)
                    <tr>
                        <td><i><a href="{{ route('studentShow',$pay->user->id ?? '') }}">{{ $pay->user->name ?? '' }} {{ $pay->user->surname ?? '' }}</a></i></td>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body py-lg-10 px-lg-10">
                                    <div
                                        ...
                                        <form action="{{ route('studentPayUpdate') }}" method="POST" class="form" novalidate="novalidate" id="">
                                            @csrf
                                            @method('PATCH')
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-4 col-sm-4 col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" min="1" name="amount" value="{{ $pay->amount }}" placeholder="Amount" class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xs-4 col-sm-4 col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" min="1" name="month" value="{{ $pay->month }}" placeholder="Month" class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xs-4 col-sm-4 col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" min="1" name="days" value="{{ $pay->days }}" placeholder="Days" class="form-control">
                                                    </div>
                                                </div>
