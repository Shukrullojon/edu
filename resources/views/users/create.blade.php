        ...
        <div class="row">
            ...
            <div class="col-xs-2 col-sm-2 col-md-2">
                <div class="form-group">
                    ...
                    {!! Form::select('days[]', $days,[], ['id'=>'day','required'=>true,'data-control'=>'select2','class' => 'form-control form-select-solid','multiple']) !!}
                </div>
            </div>
            ...
            <div class="col-xs-3 col-sm-3 col-md-3">
                <div class="form-group">
                    <label for="role"><strong>Role:</strong></label>{!! Form::label('role',"*",['style'=>"color:red"]) !!}
                    {!! Form::select('roles[]', $roles,[], ['id'=>'role','required'=>true,'class' => 'form-control','multiple', 'data-control'=>'select2']) !!}
                </div>
            </div>
