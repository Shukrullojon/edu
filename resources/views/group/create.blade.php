...
@section('content')
    <div class="card mb-12 mb-xl-12" id="kt_profile_details_view" style="margin: 10px; padding: 10px">
        ...
        {!! Form::open(array('route' => 'group.store','method'=>'POST')) !!}
            ...
            <hr>
            <h3>Teachers</h3>
            <div class="row" id="teacher_part">
                <div class="col-xs-2 col-sm-2 col-md-2">
                    <div class="form-group">
                        <label for="begin_time"><strong>Begin Time</strong></label>
                        {!! Form::time('[0]begin_time', null, ['id'=>'begin_time','class' => 'form-control']) !!}
                    </div>
                </div>
                ...
                <div class="col-xs-2 col-sm-2 col-md-2">
                    <div class="form-group">
                        ...
                        {!! Form::time('[0]end_time', null, ['id'=>'end_time','class' => 'form-control']) !!}
                    </div>
                </div>
                ...
                <div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="form-group">
                        ...
                        {!! Form::select('[0]teacher',$teachers, null, ['id'=>'teacher','class' => 'form-control', 'data-control'=>"select2"]) !!}
                    </div>
                </div>
                ...
                <div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="form-group">
                        ...
                        {!! Form::select('[0]room', $rooms,null, ['id'=>'room','class' => 'form-control', 'data-control'=>"select2"]) !!}
                    </div>
                </div>
            ...
            <div class="row" id="student_part_show">
                <div class="col-xs-2 col-sm-2 col-md-2" style="margin-top: 10px" id="p_2_0">
                    <div class="form-group">
                        <select class="form-control student_select2" name="students[]" id="choose_student" data-control="select2">
                            <option value="">Select students</option>
                            @foreach($students as $student)
                                <option value="{{ $student->id }}">{{ $student->name }} {{ $student->surname }} {{ $student->phone }} {{ $student->id_code }}</option>
                            @endforeach
